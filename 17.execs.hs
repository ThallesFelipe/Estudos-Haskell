...
-- usando recursividade explícita
formataLinhas2 :: [(Nome, Preco)] -> String
formataLinhas2 [] = ""
formataLinhas2 (item : resto) = formataLinha item ++ formataLinhas2 resto
...
procuraCodigo ((cod1, nome, preco) : resto) cod2
